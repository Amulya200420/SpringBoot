      ...
      <div class="video-overlay header-text">
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <div class="caption">
              <h2>Are You Looking for Career <br> Counselling Online?</h2>
              <p>AS offers the best of its kind online career counselling in India. Get in touch with us to seek help from the finest career counsellors online and take your career to a new high.</p>
              <div class="main-button-red">
                  <div ><a href="stdreg.jsp">Join Us Now!</a></div>
              </div>
          </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="categories">
            ...
            <ul>
              <li><a href="#">New Lecturers Meeting</a></li>
              <li><a href="#">Higher Education Conference</a></li>
              <li><a href="#">Student Training Meetup</a></li>
              <li><a href="#">Online Teaching Techniques</a></li>
